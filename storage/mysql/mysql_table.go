...
type CollectionList struct {
	...
	PhoneNumber string `gorm:"column:phone_number;type:varchar(16)"`
	Name string `gorm:"column:name;type:varchar(128)"`
	Theme string `gorm:"column:theme;type:varchar(128)"`
	ThemeUuid string `gorm:"column:theme_uuid;type:varchar(128)"`
}
...
type FollowList struct {
	...
	PhoneNumber string `gorm:"column:phone_number;type:varchar(16)"`
	Name string `gorm:"column:name;type:varchar(128)"`
	StarName string `gorm:"column:star_name;type:varchar(128)"`
	StarUuid string `gorm:"column:star_uuid;type:varchar(128)"`
}
...
type FansList struct {
	...
	PhoneNumber string `gorm:"column:phone_number;type:varchar(16)"`
	Name string `gorm:"column:name;type:varchar(128)"`
	FansNames string `gorm:"column:fans_name;type:varchar(128)"`
	FansUuid string `gorm:"column:fans_uuid;type:varchar(128)"`
}
...
type TopicList struct {
	...
	PhoneNumber string `gorm:"column:phone_number;type:varchar(16)"`
	Name string `gorm:"column:name;type:varchar(128)"`
	GroupName string `gorm:"column:group_name;type:varchar(128)"`
	GroupUuid string `gorm:"column:group_uuid;type:varchar(128)"`
}
